...
红薯台是运行在买家自己 Mac 上、以团队协作为核心的 AI 内容运营平台。小红书是第一条完整链路；知乎 V1 当前接入账号、专栏文章创作和文本审核，正式发布能力仍在独立设计与真实账号验收中。当前版本定位为 **macOS Apple Silicon 付费测试版**，不是 SaaS：业务数据库、账号 Cookie、AI Key 和发布素材都保存在本机。
